	...
	NEW_ACTION = function() { !
		function(n) {
			...
			function s(n, e, t, i) {
				...
				n = n + s + r(e),
				a(n,
				function(n) { - 1 !== o && "ok" != n && (clearTimeout(o), t(n))
				},
				i),
				h[c] = function(n) {
					delete h[c],
			...
			w = function(n, e, t) {
				n.addEventListener ? n.addEventListener(e, t, !1) : n.attachEvent ? n.attachEvent("on" + e,
				function(n) {
					return t(n || h.event)
				}) : n["on" + e] = function(n) {
					return t(n || h.event)
			...
			A = function(n) {
				for (var e = n.offsetLeft,
				t = n.offsetParent; null !== t;) e += t.offsetLeft,
				t = t.offsetParent;
				return e
			},
			T = function(n) {
				for (var e = n.offsetTop,
				t = n.offsetParent; null !== t;) e += t.offsetTop,
				t = t.offsetParent;
				return e
			};
			n.exports = {
		...
		function(n, e, t) {
			...
			e.setCookie = function(n, e, t) {
				...
				document.cookie = [encodeURIComponent(n), "=", encodeURIComponent("" + e), ";expires=", i.toGMTString()].join("")
			},
			e.send = function(n) {
				var e = p("_nc_r_"),
				t = u[e] = new Image;
			...
			e.isIEX = function(n) {
				...
				return e.innerHTML = "<!--[if IE " + n + "]><i></i><![endif]-->",
			...
			h = {
				...
				after: function(n, e) {
					return function() {
						...
						return e.call(this, t, arguments),
						t
					}
				}
			};
		...
		function(n, e, t) {
			...
			i.prototype = {
				...
				then: function(n, e) {
					...
					r = o(t, n, "resolve"),
					a = o(t, e, "reject");
					return this._state === u ? r(this._value) : this._state === f ? a(this._reason) : (this._onFulfilled.push(r), this._onRejected.push(a)),
					t
				},
				resolve: function(n) {
					this._state === l && (this._state = u, this._value = n, s(this._onFulfilled,
					function(e) {
						e(n)
					}), this._onFulfilled = [])
				},
				reject: function(n) {
					this._state === l && (this._state = f, this._reason = n, s(this._onRejected,
					function(e) {
						e(n)
					}), this._onRejected = [])
				},
		...
		function(n, e, t) {
			...
			e.log = function(n, e) {
				...
				l = c.length;
				for (t = 0; l > t; t++) r = c[t],
				n.hasOwnProperty(r) && s.push(r + "=" + encodeURIComponent(n[r]));
		...
		function(n, e) {
			...
			p = function(n) {
				var e;
				return function() {
					return "undefined" == typeof e && (e = n.apply(this, arguments)),
					e
				}
			},
			_ = p(function() {
		...
		function(n, e, t) {
			...
			function() {
				var t = {
					...
					create: function(n, e) {
						...
						u = function(n) {
							...
							s[n.name] = s[n.name] || {};
							for (var i = 0; i < e.length; i++) l[e[i]] = l[e[i]] || [],
							l[e[i]].push(n.name),
					...
					afterEvent: function(n, e, i, o, r) {
						t.afterThisEvent(n, e, i, o, r),
						t.afterAnyEvent(n, e, i, o, r)
					},
					...
					enterState: function(n, e, i, o, r) {
						t.enterThisState(n, e, i, o, r),
						t.enterAnyState(n, e, i, o, r)
					},
					buildEvent: function(n, e) {
						return function() {
							...
							if (i === o) return t.afterEvent(this, n, i, o, r),
				...
				"undefined" != typeof n && n.exports && (e = n.exports = t),
				e.StateMachine = t
			} ()
		},
		function(n, e, t) {
		...
		function(n, e, t) {
			...
			function r(n) {
				...
				t && e && a && (e.parentNode.insertBefore(t, e), a.style.display = "none"),
				s = !1
			}
		...
		function(n, e, t) {
			...
			function i(n) {
				...
				if (p.navigator.cookieEnabled && !t) {
					...
					if ( - 1 != r) {
						r += n.length + 1;
						var a = _.cookie.indexOf(";", r); - 1 == a && (a = _.cookie.length),
			...
			function o(n, e, t) {
				...
				var i = new Date;
				i.setTime(i.getTime() + 864e5 * t),
				_.cookie = [encodeURIComponent(n), "=", encodeURIComponent("" + e), ";expires=", i.toGMTString()].join("")
			}
			function r() {
		...
		function(n, e, t) {
			...
			function r(n, e, t) {
				...
				function() {
					...
					for (var r, s = ["innerWidth", "innerHeight", "outerWidth", "outerHeight", "screenX", "screenY", "availWidth", "availHeight", "colorDepth", "width", "height"], l = [], u = 0, f = s.length; f > u; u++) r = s[u],
					l.push(a[r] || "-");
					...
					var g, h = p + "&jsInfo=" + d;
					_.indexOf("AppleWebKit") > 0 && navigator.vendor && -1 !== navigator.vendor.indexOf("Apple") ? (g = c.createElement("iframe"), g.src = h) : (g = new Image, g.src = h),
			...
			e.load = function(n, e) {
				...
				function(i) {
					t = 1;
					var r = i == f; ! o && a && (r && (n._err = "TIMEOUT_uab"), e(r), o = 1)
				},
				s),
				r(c,
				function(i) {
					a = 1;
					var r = i == f; ! o && t && (r && (n._err = "TIMEOUT_um"), e(r), o = 1)
				},
				s)
			}
		},
			...
			e.init = function(n, e) {
				...
				n.onenterts_verifying = function() {
					...
					function(e, t, i) {
						...
						a = t && t.result || {};
						a.csessionid = i,
						r ? n.ts_verifypass(a) : (o++, "timeout" === e ? (n.ts_verifyerror(a), o = 0) : "number" == typeof l.errorTimes && o >= l.errorTimes ? (n.ts_verifyerror(a), o = 0) : n.ts_verifyfail(a))
					})
				},
		...
		function(n, e, t) {
			...
			e.makeNC = function() {
				var n = function s(n) {
					this.nc_obj = i(n) ? new r.NC2(n, c) : new o.NoCaptcha,
					s.__nc = this.nc_obj;
					var e = this,
					t = this.nc_obj;
				...
				t(75);
				var e = t(11);
				return n.upLang = e.upLang,
				n.init = function(e) {
					var t;
					return i(e) ? t = new r.NC2(e, c) : (t = new o.NoCaptcha, t.init(e)),
					n.__nc = t,
					t
				},
		...
		function(n, e, t) {
			...
			i.prototype = {
				...
				_reset: function() {
					...
					this.options.appkey && this.options.token && (UA_Opt.LogVal = "_n", a.init(this.options), UA_Opt.Token = (new Date).getTime() + ":" + this.options.token, UA_Opt.reload && UA_Opt.reload())
				},
				reset: function() {
		...
		function(n, e, t) {
			...
			f = function() {
				...
				{
					key: "on",
					value: function(n, e) { (this.event_listeners[n] = this.event_listeners[n] || []).push(e)
					}
				},
				{
					key: "reg",
			...
			e.makeClickSlider = function(n) {
				...
				function a(e) {
					...
					function() {
						...
						p.innerHTML = '<span class="nc-iconfont icon-left-triangle"></span>' + o.trans(n.options.language, "CLICK_LABEL_READY")
					}),
					n.on("success",
					function() {
				...
				function u() {
					...
					for (var e in n) if (void 0 !== v.style[e]) return {
						end: n[e]
					};
					return ! 1
				}
		...
		function(module, exports, __webpack_require__) {
			...
			Scrape = function() {
				function Scrape(n) {
					...
					this.root = n.el;
					var t = {};
					if (e.foreign && (t.language = t.language || "en"), this.options = util.mix({},
					cfg.default_options, t, n.options || {},
					e), this._last_x = -1, this._last_y = -1, this.stroke_size = e.stroke_size || cfg.default_stroke_width, this.svr_data = {},
					this._t_action = null, this.is_downgraded = !1, this._lang = language[this.options.language] || language.cn, this.options.upLang) for (var i in this.options.upLang) this._lang = replaceLang(i, this.options.upLang[i]);
					this.scrapeStart = !1,
					this.showingHow = !1,
					this.mousedown = !1,
					this.reg();
				...
				},
				{
					...
					value: function() {
						...
						for (var o = cfg.grid_size,
						r = Math.ceil(t / o), a = Math.ceil(i / o), c = [], s = this.options.bg_back, l = 0; a > l; l++) for (var u = 0; r > u; u++) {
							var f = o * l,
							d = o * u,
							p = {
								width: o + "px",
						...
						util.on(e, "touchstart",
						function(e) {
							return n.eventDown(e)
						}),
						util.on(document, "touchend",
						function(e) {
							return n.eventUp(e)
						}),
						util.on(e, "touchmove",
				...
				},
				{
					...
					value: function(n, e) {
						...
						t.fill(),
						this._last_x >= 0 && this._last_y >= 0 && (t.beginPath(), t.lineWidth = this.stroke_size, t.moveTo(this._last_x, this._last_y), t.lineTo(n, e), t.stroke()),
						this._last_x = n,
						this._last_y = e
					}
				},
				...
				},
				{
					...
					value: function(n, e, t, i) {
						for (var o = cfg.grid_size,
						r = Math.floor(n / o), a = Math.floor(e / o), c = Math.floor(t / o), s = Math.floor(i / o), l = 0, u = a; a + s > u; u++) for (var f = r; r + c > f; f++) {
				...
				},
				{
					...
					value: function() {
						...
						r = this.obj_w / 2 * o,
						a = this.obj_h / 2 * o;
						return t = util.map(this._points,
						function(e) {
							var t = e.x,
							i = e.y;
						...
						new Promise(function(resolve, reject) {
							...
							function(n, e) {
								...
								if (e.success && e.result && e.result.success) {
									...
									if (0 === i.code) return _this10.verify_ok(i),
									void resolve();
				...
				},
				{
					...
					value: function(n, e, t) {
						...
						return n = n.replace(/%TYPE\b/, i.type),
				...
				},
				{
					...
					value: function(n) {
						...
						if ("ready" == this.nc.fsm.current) {
							this.scrapeStart || (this._last_x = -1, this._last_y = -1, this.render_surface()),
							this.showingHow = !1,
							this.scrapeStart = !0,
							this.mousedown = !0,
				...
				},
				{
					...
					value: function() {
						...
						this._last_x = -1,
						this._last_y = -1,
						this.is_downgraded && (doc.body.onselectstart = this._old_onselectstart, doc.body.ondrag = this._old_ondrag),
					...
					value: function() {
						...
						return new Promise(function(e, t) {
							try {
								...
								}), n.showEl("loading"), n.hideEl("load-error"), n.getEl("title").innerHTML = n._lang._ggk_guide, n.bindEvents(), n.size = n.getSize(), n.getEl("container").style.width = n.size.width + "px", n.render_bg(), n.el_canvas = n.getEl("canvas"), !n.el_canvas.getContext || !(n.ctx = n.el_canvas.getContext("2d"))) return n.downgrade(),
								n.render_surface_dg(),
								void e();
								n.render_surface(),
								e()
		...
		function(n, e, t) {
			...
			e.makeSlider = function(n) {
				...
				function a() {
					...
					T > X && (o.addClass(m, "mv-back"), o.addClass(y, "mv-back"), m.style.left = "0", y.style.width = g + "px", setTimeout(function() {
		...
		function(n, e, t) {
			...
			e.init = function(n, e) {
				n.onenterload_error = function() {
					e.ui.setActiveStage(3, "01"),
					e.options.error("load_error")
				}
			}
		},
		function(n, e, t) {
			...
			e.init = function(n, e) {
				...
				n.onenterloading = function() {
					...
					/windvane/i.test(navigator.userAgent) && r.loadScript(n,
					function() {
						i.WindVane && i.WindVane.call("aluWVJSBridge", "getUmid", {},
						function(n) {
		...
		function(n, e, t) {
			...
			e.init = function(n, e) {
				...
				n.onenterpass = function(n, i, o, r) {
					e.slider.setTitle(t("CHECK_Y")),
					e.slider.setIcon("yes nc-iconfont icon-ok");
					var a = e.options;
					r.sig = r.sig || r.value,
			...
			e.init = function(n, e) {
				...
				function c() {
					...
					g.onerror = function() {
						var n = -1 === _.indexOf("?") ? "?": "&";
						w++,
						w >= e.options.retryTimes || w > x || setTimeout(function() {
							g.src = _ + n + "__retry=" + w
						},
						1e3)
					},
				...
				n.onenterverifying = function() {
					function n() {
						e.net.postSlide(function(n, t) {
							return - 1 != i && clearTimeout(i),
							"timeout" === n.state ? void(e.fsm.can("verifyerror") && e.fsm.verifyerror(t)) : (n.pass ? e.fsm.can("verifypass") && e.fsm.verifypass(t) : 300 == t.code ? e.fsm.can("verifyfail") && e.fsm.verifyfail(t) : e.fsm.can("verifytwostep") && e.fsm.verifytwostep(t), void(e.options.isClick && e.slider.setIcon("nc-hidden")))
						})
					}
					e.slider.disable();
		...
		function(n, e, t) {
			...
			e.makeUI = function(n) {
				...
				function l() {
					var e;
					for (e = 1; 3 >= e; e++) g[e] = t("#" + n.prefix + "-stage-" + e),
				...
				function u(e) {
					...
					if (i && (i.style.display = "none"), i = g[e], i.style.display = "block", h = e, 3 == e && t) {
						...
						o = o + "(" + t + ")",
						document.getElementById(n.prefix + "-stage-3").getElementsByTagName("div")[0].innerHTML = o
					}
					2 !== e || v.inline || f()
				}
				function f() {
